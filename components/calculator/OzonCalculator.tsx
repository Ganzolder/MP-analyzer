        ...
        <>
          ...
          {ozon.parsedData && ozon.parsedData.products.length > 0 && (
            <>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Настройки планируемой маржинальности</CardTitle>
                  <CardDescription>
                    Маржинальность из файла (если указана) имеет высший приоритет. Затем — по категории, затем — общая.
                    Процент задаётся от полной себестоимости по строке (закуп + прочие из раздела ниже): целевая чистая
                    прибыль на 1 шт. = (маржа ÷ 100) × себестоимость; расчётная цена — с учётом комиссий, логистики и налогов.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-2">
                    <Label htmlFor="global-margin">
                      Общая маржинальность (% от себестоимости)
                    </Label>
                    <Input
                      id="global-margin"
                      type="number"
                    ...
                    <p className="text-xs text-muted-foreground">
                      Доля от полной себестоимости товара (закуп + прочие на шт.). Применяется, если в файле и по категории
                      не задано своё значение
                    </p>
                  </div>
                  ...
                  {ozon.parsedData.categories.length > 0 && (
                    <div className="space-y-4">
                      <Label>
                        Маржинальность по категориям, % от себестоимости (опционально)
                      </Label>
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent className="max-w-sm">
                              <p className="text-xs">
                                ...
                                <strong>НДС 22% + НП 25%</strong> — метод 22/122 и 100/122 от начислений и от полной суммы затрат (себестоимость + прочие), затем налог на прибыль 25% от базы без НДС.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
